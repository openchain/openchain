...
namespace OpenChain.Console
{
    public class Program
    {
        ...
        private static async Task Run()
        {
            ...
            await store.AddLedgerRecords(new[] { new BinaryData(MessageSerializer.SerializeLedgerRecord(new LedgerRecord(new BinaryData(b), DateTime.UtcNow, BinaryData.Parse("123456")))) });
        }
    }
}
